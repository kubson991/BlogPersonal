  ...
  posts: [
    {
      ...
      intro:
        'Maquetacion totalmente responsive de la pagina "PatataVid" a base unicamente de HTML CSS y JS vanila , respetando principios de diseno movile first y siguiendo modelado en figma.',
      blog: 'patatavid',
...
Lo que caracteriza a esta maquetación ,es el hecho de que fue hecho sin librerías o frameworks ,solo con CSS y HTML puro destacando también el uso de JavaScript para la interactividad entre el cambio de tablas presente al presionar los iconos de flechas y tambien el uso la etiqueta <table> que ha sido ampliamente descartada por el uso de CSS grid sin tener en cuenta que en ocasiones particulares el uso de table puede evitar el uso de css sin necesidad .`,
    ...
    },
    {
      ...
      intro:
        'Y con ustedes una app que muestra todos los personajes de la popular serie Rick y Morty mediante la consulta a una API rest y el uso de Nuxt para mostrar tarjetas con la informacion de que cada personaje.',
      blog: 'RickyAndMorty',
    ...
    },
    {
      ...
      intro:
        'Creacion de sitio web acerca de heroes de DC en lego ,hecho en su totalidad con animaciones sin ayuda de bibliotecas ,con solo HTML y JS vanila (es un sitio de muestra sin enrutador).',
      blog: 'LegoBlog',
...
a pesar de ello la recarga continua permite ver la idea inicial de esta , esto no das una buena reflexión acerca del uso de APIs externas a notros y como esta puede verse afectada por un repentino cambio.  `,
    ...
    },
    {
      ...
      intro:
        'Creacion de un componente web con javaScript vanila , HTML y CSS con tematica de zapatos Nike ,siendo este componente totalmente reutilizable y compatible con cualquier framework.',
      blog: 'NikeComponent',
...
Claramente el uso de web components no es ampliamente utilizado en la industria , sin embargo su uso nos trae muchas ventajas ,entre ellas la escalabilidad ,el no uso de liberias o frameworks externos y tal vez lo mas importante, que ningun frameWork a logrado`,
    ...
    },
    {
      ...
      intro:
        'Card creada para promocionar un servicio de data analytics realizado en base a los requerimientos del cliente , enfatizando en que fuera responsive para pantallas de 320px y 1440px.',
      blog: 'BusinessCard',
    ...
    },
    {
      ...
      intro:
        'Maquetacion del sitio web de Wikipedia realizado unicamente con HTML y CSS , aclarando que no es una pagina responsive ,unicamente para computadores.',
      blog: 'wikipediaClon',
    ...
    },
    {
      ...
      intro:
        'App web totalmente responsive que obtiene datos para tener registro de las horas que se dedican a distintas actividades, usando web components.',
      blog: 'calendarCSS',
    ...
    },
    {
      ...
      intro:
        'Calculadora 100% responsive y reactiva para calcular y dividir propinas en dolares,programada con Nuxt y el paradigma de movile first.',
      blog: 'TipCalculator',
...
Lo que permite una gran fluidez en el uso de esta app es la reactividad de los v-model ,propiedad que caracteriza a Vue para rapido y facil desarrollo de componentes con inputs.`,
    ...
    },
    {
      ...
      intro:
        'Contador de tiempo de dias a segundos ,con enfoque empresarial ,actualmente esta adaptado para que sea un contador hasta el proximo diciembre (100% responsive).',
      blog: 'Counter',
...
Esta pagina destaca en el uso de animaciones continuas e intercaldas para lograr un efecto de giro en los numeros y de un nevado continuo que parece no acabar.`,
    ...
    },
    {
      ...
      intro:
        'Contador de tiempo de dias a segundos ,con enfoque para streamers ,actualmente esta adaptado para que sea un contador hasta que acabe mi licencia de platzi.',
      blog: 'CounterTwitch',
    ...
    },
    {
      ...
      titulo: 'To do`s App',
      intro:
        'Aplicacion multiplataforma que recibe tareas y se indica si estan completadas o no, la informacion es guardada mediante el storage.',
      blog: 'Todos',
    ...
    },
    {
      ...
      titulo: 'Portafolio',
      intro:
        'Este blog es la recopilación de todo lo que he aprendido a lo largo de mi trayectoria académica y profesional, para mí esto no es un simple proyecto más , esta es la evidencia de lo que he logrado.',
      blog: 'MiBlog',
...
Al día de hoy muchos desarrolladores discuten cuando usar display flex y cuando display grid, la realidad es que la combinación de ambos puede ser siempre la mejor respuesta, este blog presenta un patrón que enfatiza en uso de Flex para su maquetación y Grid para sus componentes más pequeños teniendo así lo mejor de ambos mundos y por supuesto no olvidemos el uso de VueJS con Nuxt que hace posible el enrutamiento y división por módulos del proyecto.`,
    ...
    {
      imagen:
        'v1641312782/blogPersonal/blogs/imagen_2022-01-04_111301_dokxam.png',
      alt: 'SunnnySide',
      titulo: 'SunnySide',
      intro:
        'Pagina de inicio para pagina de servicios de fotografia y diseño creada en React ,100% responsive con menu desplegable en responsive y tecnica parallax para desktop.',
      blog: 'SunnnySide',
      post: 'Pagina de inicio para pagina de servicios de fotografia y diseño creada en React ,100% responsive con menu desplegable en responsive y tecnica parallax para desktop,esta pagina no tiene ningun computo o reactividad es por ello que no lo considerare una aplicacion sin embargo es necesario recalcar que se realizo mediante React-Create-App que es una manera de installar un entorno preconfigurado de React de manera agil.',
      direccion: 'https://romantic-tereshkova-9e2fd8.netlify.app/',
      tags: ['CSS', 'HTML', 'JS', 'Node', 'React', 'RWD'],
    },
    {
      imagen:
        'v1641312702/blogPersonal/blogs/imagen_2022-01-04_111141_xnfrot.png',
      alt: 'animacion',
      titulo: 'Contexto de apilamiento',
      intro:
        'Sencillo juego realizado SOLO con css y html que muestra un bucle de animacion realizado tambien con un contador.',
...
Se que estas pensando, "pero esto no tiene nada de especial... incluso si presiono dos veces el mismo personaje se resta el score" bien te dire lo interensate y es que, no tiene javaScript! este mini juego, maneja su logica mediante CSS ,lo cual puede dejar pensando a màs de uno :) .`,
    ...
    {
      imagen:
        'v1644351654/blogPersonal/blogs/imagen_2022-02-08_152052_bidpvw.png',
      alt: 'ahorcado',
      titulo: 'Juego de ahorcado',
      intro:
        'Juego 100% responsive realizado en React ,enfatizando en la funcionalidad y no en su css.',
      blog: 'ahorcado',
    ...
    {
      imagen: 'v1658638784/blogPersonal/blogs/weekBalance_ddgqhb.png',
      alt: 'week balance',
      titulo: 'Week balance',
      intro:
        'aplicativo web que grafica tu gasto semanal y calcula tu gasto total y potencial ahorro.',
      blog: 'Week balance',
      post: 'aplicativo web que grafica tu gasto semanal y calcula tu gasto total y potencial ahorro ,su desarrollo fue en React con ayuda del Framework "Vite" conocido por su eficiencia , en desarrollo se enfatiza en la componetizacion de la grafica y popup y por su puesto libre de librerias mas alla del mismo React y teniendo en cuenta que esta enfatizada en su uso para moviles sin perder funcionalidad al usarse en computadoras. ',
      direccion: 'https://luxury-tulumba-69de77.netlify.app',
      tags: ['CSS', 'HTML', 'JS', 'Node', 'React', 'RWD', 'Vite'],
    },
    {
      imagen:
        'v1658787655/blogPersonal/blogs/imagen_2022-07-25_172052506_idk86z.png',
      alt: 'Advice APP',
      titulo: 'Advice App',
      intro:
        'Aplicativo web que consulta una api de consejos cada vez que se presiona el boton.',
      blog: 'Advice App',
      post: 'Aplicativo web que consulta una api de consejos cada vez que se presiona el boton,realizada en React con Vite ,creada principalmente para movil pero es multiplafaforma ,solicita los consejos de una Api rest externa.',
      direccion:
        'https://62df22f00dc7c400092aff6b--imaginative-kulfi-fd4c14.netlify.app',
      tags: ['CSS', 'HTML', 'JS', 'Node', 'React', 'RWD', 'Vite'],
    },
    {
      imagen:
        'v1659074856/blogPersonal/blogs/imagen_2022-07-29_010733088_zunhhr.png',
      alt: 'Space Page',
      titulo: 'Space Page',
      intro: 'SPA realizada con React en Vite con multiples rutas dinamicas.',
      blog: 'Space Page',
      post: 'Single Page Aplication realizada con React en Vite con multiples rutas dinamicas ,multiples endpoints responsive y renderizado condicional.',
      direccion: 'https://resilient-griffin-12d934.netlify.app',
      tags: ['CSS', 'HTML', 'JS', 'Node', 'React', 'RWD', 'Vite'],
    },
    {
      imagen:
        'v1659408199/blogPersonal/blogs/imagen_2022-08-01_214315912_zvye3u.png',
      alt: 'Rock,Paper,Scissors....',
      titulo: 'Rock,Paper,Scissors....',
      intro:
        'Clasico juego de piedra,papel y tijera MAS spock y lagarto realizado con React y Vite ,enfatizado en su version mobile.',
      ...
      direccion:
        'https://62e88e169428a6660bf9051b--stirring-peony-69f790.netlify.app',
      tags: ['CSS', 'HTML', 'JS', 'Node', 'React', 'RWD', 'Vite'],
    },
    {
      imagen:
        'v1659852958/blogPersonal/blogs/imagen_2022-08-07_011558055_smrzzv.png',
      alt: 'where in the world img',
