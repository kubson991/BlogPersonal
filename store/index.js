...
Al día de hoy muchos desarrolladores discuten cuando usar display flex y cuando display grid, la realidad es que la combinación de ambos puede ser siempre la mejor respuesta, este blog presenta un patrón que enfatiza en uso de Flex para su maquetación y Grid para sus componentes más pequeños teniendo así lo mejor de ambos mundos y por supuesto no olvidemos el uso de VueJS con Nuxt que hace posible el enrutamiento y división por módulos del proyecto.`,
		...
		},
		{
			...
			alt: 'SunnnySide',
			titulo: 'SunnySide',
			intro: 'Pagina de inicio para pagina de servicios de fotografia y diseño creada en React ,100% responsive con menu desplegable en responsive y tecnica parallax para desktop.',
			blog: 'SunnnySide',
...
Se que estas pensando, "pero esto no tiene nada de especial... incluso si presiono dos veces el mismo personaje se resta el score" bien te dire lo interensate y es que, no tiene javaScript! este mini juego, maneja su logica mediante CSS ,lo cual puede dejar pensando a màs de uno :) .`,
		...
		},
		{
			...
			alt: 'week balance',
			titulo: 'Week balance',
			intro: 'aplicativo web que grafica tu gasto semanal y calcula tu gasto total y potencial ahorro.',
			blog: 'Week balance',
		...
		{
			imagen:'v1658787655/blogPersonal/blogs/imagen_2022-07-25_172052506_idk86z.png',
			alt: 'Advice APP',
			titulo: 'Advice App',
			intro: 'Aplicativo web que consulta una api de consejos cada vez que se presiona el boton.',
			blog: 'Advice App',
			...
			direccion:'https://62df22f00dc7c400092aff6b--imaginative-kulfi-fd4c14.netlify.app',
			tags:['CSS','HTML','JS','Node','React','RWD','Vite'],
		},
		{
			imagen:'v1659074856/blogPersonal/blogs/imagen_2022-07-29_010733088_zunhhr.png',
			alt: 'Space Page',
			titulo: 'Space Page',
